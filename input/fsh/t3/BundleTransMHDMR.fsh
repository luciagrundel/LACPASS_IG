Alias: $LACBundleDocMR = http://racsel.org/StructureDefinition/LACBundleDocMR

Profile: LACBundleTransactionMHDMR
...
* entry[FhirDocuments].resource only $LACBundleDocMR
...
* entry[DocumentRefs].resource only LACDocReferenceMR
