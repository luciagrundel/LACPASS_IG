...
> **GET ServiceRequest [ServidorOrigen]/(?performer = Organization/{pais_origen} , patient = [ URL / MPI ]**
...
> **GET DocumentReference [ServidorDestino]/( ?type = [ code= Interconsulta Transfronteriza ] , patient = [ URL / MPI ] )**
